		...
		<div class="card card-body bg-light mt-5">
	        ...
	        <form action="<?= URLROOT; ?>/users/register" method="post">
				<div class="form-group">
					...
					<input type="text" name="first_name" class="form-control form-control-lg <?= (!empty($data['first_name_err'])) ? 'is-invalid' : ''; ?>" value="<?= $data['first_name']; ?>">
					<span class="invalid-feedback"><?= $data['first_name_err']; ?></span>
				</div>
				<div class="form-group">
					<label for="last_name">Last Name: <sup>*</sup></label>
					<input type="text" name="last_name" class="form-control form-control-lg <?= (!empty($data['last_name_err'])) ? 'is-invalid' : ''; ?>" value="<?= $data['last_name']; ?>">
